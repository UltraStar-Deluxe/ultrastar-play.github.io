const WaveBackground = (props: { flipX: boolean, flipY: boolean, colorFrom: string, colorTo: string }) => (
    ...
    <svg width="100%" height="100%" id="svg" viewBox="0 0 1440 281"
        ...
        <defs>
            <linearGradient id="gradient" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop offset="5%" stop-color={props.colorFrom}></stop>
                <stop offset="95%" stop-color={props.colorTo}></stop>
            </linearGradient>
        </defs>
        <path
